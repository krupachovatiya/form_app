    ...
    <div className='main-1'>
      <div className='form-login'>
        ...
        <div className='input-login'>
          <input type='email' name='email' value={data.email} onChange={handleChange}
            placeholder='Email'/>
            {errors.email && <p className='error-login'>{data.email === '' ? 'Email is required' : 'Invalid email'}</p> }
        </div>                   
        <br/>
        ...
        <div className='input-login'>
          <input type='password' name='password' value={data.password} onChange={handleChange}
            ...
            {errors.password && <p className='error-login'>{data.password === '' ? 'Password is required' : 'Please enter strong password'}</p> }
        </div>                   
        <br/>
        ...
        <div className='signup'>
          <p className='signup-link'>  Don't have an account?<Link to='/'>Sign up</Link>
          </p> 
        </div>
      </div>
      ...
      <div className='form-login2'>
        <div className='link-login'>
          <Link to='/' className='signup-login'>Sign up</Link>
          <Link to='/login' className='link-login1'>Log in</Link>
        </div>
        <div className='logo-login1'>
          <h4>Largest Space Community</h4>
        </div>
        <div className='content-login'>                
          <h1 className='login-title1'>Go anywhere you want in a Galaxy full of wonders!</h1>
